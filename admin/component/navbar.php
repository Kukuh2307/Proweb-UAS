...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-light">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3 text-white" href="<?= $url ?>index.php">DASHBOARD</a>
        <!-- Sidebar Toggle-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Profile Pengguna</h5>
                ...
                <div class="modal-body">
                    <div class="card mb-3 border-0" style="max-width: 540px;">
                        <div class="row g-0">
                            <div class="col-md-3">
                                <!-- gambar -->
                                <img src="<?= $url ?>/asset/image/User-Image/<?= $profile['picture'] ?>" class="img-fluid rounded-start" width="100" alt="<?= $profile['nama'] ?> ">
                            </div>
                            <div class="col-md-9">
                                <div class="card-body">
                                    <!-- jabatan -->
