                ...
                <div class="card-body">
                    <table class="table table-hover" id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $querySelect = mysqli_query($koneksi, "SELECT * FROM syaratdanketentuan");
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <a href="<?= $url ?>/admin/route-admin.php?msg=editsyaratdanketentuan&id=<?=$data['id']?>" class="btn btn-sm btn-warning" title="Edit"><i class="fa-solid fa-pen"></i></a>
