...
if (isset($_GET['id'])) {
    ...
    $id = $_GET['id'];
    $querySelect = mysqli_query($koneksi, "SELECT * FROM informasipengiriman WHERE id='$id'");
            ...
            <form action="section/proses-edit-infopengiriman.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="h5"><i class="fa-solid fa-square-plus"></i> Edit Informasi Pengiriman</span>
