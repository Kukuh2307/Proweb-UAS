                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control border-0 border-bottom" id="judul" name="judul" style="margin-left: -2.5rem;" placeholder="Masukkan judul blog" value="<?= $data['judul'] ?>" required>
                                    </div>
                                </div>
