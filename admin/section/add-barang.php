                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <label for="" class="col-sm-1 col-form-label">:</label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control border-1 border-bottom" id="deskripsi" name="deskripsi" maxlength="60" style="margin-left: -2.5rem;" placeholder="Masukkan deskripsi barang" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <label for="" class="col-sm-1 col-form-label">:</label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control border-0 border-bottom" id="harga" name="harga" maxlength="60" style="margin-left: -2.5rem;" placeholder="Masukkan harga barang" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <label for="" class="col-sm-1 col-form-label">:</label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control border-0 border-bottom" id="stok" name="stok" maxlength="60" style="margin-left: -2.5rem;" placeholder="Masukkan stok barang" required>
                                    </div>
                                </div>
                            </div>
