                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <textarea class="form-control border-1 border-bottom" id="summernote" name="deskripsi" placeholder="Masukkan isi Kebijakan Pribadi" style="height: 12rem;" required><?= $data['deskripsi'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
