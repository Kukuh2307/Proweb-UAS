    ...
    <div class="container" style="margin-top: 6rem; text-align: justify">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h2 class="text-center">Kebijakan Pribadi</h2>

                <p>Your privacy is important to us. It is our policy to respect your privacy regarding any information
                    we may collect from you across our website.</p>
